...
# Generated by `aicoach install` / `aicoach config validate`. Explicit
# environment overrides set before sourcing still take precedence.
[[ -r $HOME/.config/aicoach/keybindings.zsh ]] && source $HOME/.config/aicoach/keybindings.zsh
typeset -g AICOACH_LANGUAGE=${AICOACH_LANGUAGE:-en-US}
...
unfunction _aicoach_bind_widget

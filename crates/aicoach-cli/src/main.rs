...
[[ -n ${{AICOACH_COMPLETION_KEY+x}} ]] || typeset -g AICOACH_COMPLETION_KEY=$'{completion}'\n\
[[ -n ${{AICOACH_CHAT_KEY+x}} ]] || typeset -g AICOACH_CHAT_KEY=$'{chat}'\n\
[[ -n ${{AICOACH_RISK_LENS_KEY+x}} ]] || typeset -g AICOACH_RISK_LENS_KEY=$'{risk_lens}'\n\
[[ -n ${{AICOACH_TOGGLE_KEY+x}} ]] || typeset -g AICOACH_TOGGLE_KEY=$'{toggle}'\n\
[[ -n ${{AICOACH_LANGUAGE+x}} ]] || typeset -g AICOACH_LANGUAGE='{}'\n\
[[ -n ${{AICOACH_SAFETY_ENABLED+x}} ]] || typeset -gi AICOACH_SAFETY_ENABLED={}\n\
[[ -n ${{AICOACH_INLINE_HINT+x}} ]] || typeset -gi AICOACH_INLINE_HINT={}\n",
